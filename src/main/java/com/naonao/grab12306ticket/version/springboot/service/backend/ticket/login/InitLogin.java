package com.naonao.grab12306ticket.version.springboot.service.backend.ticket.login;

import com.alibaba.fastjson.JSONObject;
import com.naonao.grab12306ticket.version.database.backend.resultclass.ticket.login.InitLoginReturnResult;
import com.naonao.grab12306ticket.version.database.backend.ticket.login.common.AbstractLogin;
...
public class InitLogin extends AbstractLogin {
    ...
    private Boolean logDevice(){
        ...
        try{
            ...
            if (response.getStatusLine().getStatusCode() == HTTP_SUCCESS){
                ...
                // resultMap.put("RAIL_EXPIRATION", "1558017804621");
                // resultMap.put("RAIL_DEVICEID", "b-7ISs7TrhbYqeprEYgRRlxk-WKPRFIykwl02aGJMH8RfGzu4rIvqVMEJg71kaN8Qn-8wO9ZDQsHXv1xo6tOHGvzjApcKrcP8fFPAyhfiy_oSHGVW8qP91ob327YL8XOCBIhs_2nS_6aSi5qVa4ztBlKXWvKk1Ju");
    ...
    private URI logDeviceUri(String url, String timeValue){
        ...
        try{
            ...
            //         .build();
            // return uri;
            return new URI("https://kyfw.12306.cn/otn/HttpZF/logdevice?algID=vcpH2oJtig&hashCode=tChMIZrtGehMbhGae7Lqe17Jcgd_cmo9naGf6CouroU&FMQw=0&q4f3=zh-CN&VySQ=FGHk8hqpvc5Q_Z7mhyp31spb7lnu9gYr&VPIf=1&custID=133&VEek=unknown&dzuS=0&yD16=0&EOQP=8f58b1186770646318a429cb33977d8c&lEnu=3232235976&jp76=52d67b2a5aa5e031084733d5006cc664&hAqN=Win32&platform=WEB&ks0Q=d22ca0b81584fbea62237b14bd04c866&TeRS=1040x1920&tOHY=24xx1080x1920&Fvje=i1l1o1s1&q5aJ=-2&wNLf=99115dfb07133750ba677d055874de87&0aew=Mozilla/5.0%20(Windows%20NT%2010.0;%20Win64;%20x64)%20AppleWebKit/537.36%20(KHTML,%20like%20Gecko)%20Chrome/74.0.3729.131%20Safari/537.36&E3gR=5aa5880dde0b352c55aab2c15cbfbe41&timestamp=" + timeValue);
