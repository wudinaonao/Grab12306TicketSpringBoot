 ...
 **/
@Slf4j
public class SendEmail extends AbstractNotification {
    ...
    private MimeMessage getMessage(Session session, String sender, String receiver, String subject, String text, boolean isHtml) {
        // create email object
        try{
