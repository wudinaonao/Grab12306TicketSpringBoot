 ...
 **/
@Slf4j
public class YunzhixinVoice extends AbstractNotification {
    ...
    public YunzhixinVoice(String appCode, String templateId){
    ...
    private URI createUri(String phoneNum, String templateId){
        try{
            return new URIBuilder("http://yzxyytz.market.alicloudapi.com/yzx/voiceNotifySms")
