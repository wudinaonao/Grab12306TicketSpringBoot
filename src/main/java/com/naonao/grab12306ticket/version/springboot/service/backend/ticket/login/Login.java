...
import com.naonao.grab12306ticket.version.database.backend.resultclass.ticket.login.*;
...
import com.naonao.grab12306ticket.version.database.backend.ticket.captcha.Captcha;
...
public class Login extends AbstractLogin {
     ...
     */
    public synchronized LoginReturnResult login(String username, String password) {
